...
lab = ctk.CTkCheckBox (screen ,text= "save",bg_color= "cyan",text_color= "black",width = 5, height=5,corner_radius = 2)
...
entree.pack (side="right", padx=30,pady=40,anchor = "w")
ask.pack (side = "right", padx=20 , pady=20)
lab.pack (side = "right", padx=20 , pady=20)
